...
\hluc{HLUC-8}{Generate individual statistics for a member}{ RowBuddy Report Generator}{1}{dch}{}{%
		In this use case every user can create an individual statistic. It includes creating, browsing statistics. The user can publish the own statistic and other users can see it.
		}
