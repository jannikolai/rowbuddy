...
public class Boat implements Serializable {
	...
	public void setNumberOfSeats(int numberOfSeats) throws RowBuddyException {
		if (numberOfSeats <= 0) {
			throw new RowBuddyException(
					"Ein Boot muss mindestens einen Platz haben");
		}
	...
	public void removeBoatDamage(BoatDamage boatDamage)
		...
		if (!boatDamages.contains(boatDamage)) {
			throw new RowBuddyException(
					"Bootsschaden gehoert nicht zu diesem Boot");
		}
	...
	public void validate() throws RowBuddyException {
		...
		if (numberOfSeats <= 0) {
			throw new RowBuddyException(
					"Das Boot muss mindestens einen Sitzplatz haben");
		}
	}
