...
public class MemberDTO implements Serializable {
	...
	private Collection<TripDTO> publishedTrips = new LinkedList<TripDTO>();
	...
	public Collection<TripDTO> getPublishedTrips() {
		return publishedTrips;
	}
	public void setPublishedTrips(Collection<TripDTO> publishedTrips) {
