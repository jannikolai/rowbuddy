...
The purpose of this section is to provide a brief description of the project and to describe known actors and their interaction with the system. The section presents a high level view. For more detailed information, please refer to the developer team.
	...
	\end{figure}
		...
		TODO IMAGE
		\begin{itemize}
			\item \textbf{HLUC-1:} Manage Boats
			\item \textbf{HLUC-2:} Manage Users / Accounts
			\item \textbf{HLUC-3:} Manage Routes
		\end{itemize}	
...
\hluc{HLUC-1}{Manage Users / Accounts}{ RowBuddy Online Storage}{1}{wal}{\nameref{scope}}{%
		lorem ipsum\newline	
		}

\hluc{HLUC-1}{Manage Route}{ RowBuddy Online Storage}{1}{wal}{\nameref{scope}}{%
		lorem ipsum\newline	
		}
