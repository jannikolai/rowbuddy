...
\hluc{HLUC-3}{Manage Routes}{RowBuddy Online Storage}{1}{wal}{}{%
		...
		\end{figure}
			...
			\hluc{HLUC-4}{Log rowed route}{RowBuddy Route and Event Logger}{1}{hei}{}{%
				In this use case a rowed route is recorded in the electronic logbook. The user that rowed the route sets the date and time the route ended and started, the river the route was rowed on and either the GPS coordinates of ending- and starting-points or a short description of those. The route is then added in the users profile.
			}
			\hluc{HLUC-5}{Log damaged boat}{RowBuddy Route and Event Logger}{1}{hei}{}{%
